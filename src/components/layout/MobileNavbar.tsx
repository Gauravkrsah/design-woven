      ...
      <div className={cn(
        ...
        <div className="flex items-center justify-between h-full px-4">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center overflow-hidden">
        ...
        <div className="p-4 sm:p-6 h-full overflow-auto">
            ...
            <ul className="space-y-1 sm:space-y-2">
              ...
              <li>
                <Link 
                  ...
                  onClick={closeMenu}
                >
                  <FolderKanban className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-400" />
              ...
              <li>
                <Link 
                  ...
                  onClick={closeMenu}
                >
                  <Layers className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-400" />
                  <span>Contents</span>
                </Link>
              </li>
              <li>
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <Button 
                className="w-full text-xs sm:text-sm py-1.5 sm:py-2 h-auto bg-blue-600 hover:bg-blue-500 text-white"
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="flex gap-2 sm:gap-3 ml-2 sm:ml-3">
              <a 
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors border border-gray-200 dark:border-gray-700"
              >
